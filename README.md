...
### Versiyon: 2.5.0 → 2.6.0 (Mart 2026 Geliştirmeleri - Tahsilat & Araç Modülü Revizyonu)
- **Tahsilat Modülü İki Yönlü Senkronizasyonu:** Tahsilat Geçmişi (Liste) sekmesine ve Matris Araç detay modalına "Tahsilat Düzenle", "Tahsilat Ekle", "Tahsilat Sil" özellikleri dahil edildi.
- **Cari Hesap Otomasyonu:** Herhangi bir tahsilat ödemesi düzenlendiğinde veya silindiğinde, tahsilatın bağlı olduğu cari hesaptaki (`customer_debts`) geçmiş bakiyenin %100 otomatik olarak güncellenmesi sağlandı.
- **Gelişmiş Araç ve Kiralama Modalı:** Tahsilat Matrisi üzerindeki bir araca tıklandığında açılan ekran revize edildi; aracın mevcut kiralama operasyon bilgileri (Süre, Kiralayan, Fiyat) ile birlikte "Geçmiş Tahsilat Fişleri" mini bir tablo olarak aynı ekrana gömüldü.
- **Filo Yönetimi Renk Özelliği:** Araç tanımlarına `color` niteliği kazandırıldı; araç kartlarında ve liste detaylarında renk bilgisi görünür hale getirildi.
